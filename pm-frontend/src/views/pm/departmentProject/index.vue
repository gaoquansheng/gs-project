<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="68px">
      ...
      <el-form-item label="申报人" prop="userCode">
        <el-input
      ...
      <!-- <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
        <template slot-scope="scope">
          <el-button
            ...
            v-hasPermi="['pm:departmentProject:edit']"
          >修改</el-button>
          <el-button
            size="mini"
            type="text"
            ...
            v-hasPermi="['pm:departmentProject:remove']"
          >删除</el-button>
        </template>
      </el-table-column> -->
    </el-table>
...
import {
  ...
  exportDepartmentProject
} from "@/api/pm/departmentProject";
...
export default {
  ...
  methods: {
    ...
    getList() {
      this.loading = true;
      listDepartmentProject(this.queryParams).then(response => {
        this.departmentProjectList = response.rows;
